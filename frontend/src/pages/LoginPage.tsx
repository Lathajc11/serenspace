        ...
        <div className="seren-card p-8">
          ...
          <div className="relative my-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-4 bg-white text-[var(--seren-text-secondary)]">Or continue with email</span>
            </div>
          </div>
          ...
          <p className="text-center mt-6 text-sm text-[var(--seren-text-secondary)]">
            ...
            <Link to="/signup" className="text-[var(--seren-text)] font-medium hover:underline">
              Sign up
            </Link>
          </p>
        </div>
